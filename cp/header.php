<?php
// เช็คว่ามีเซสชันที่กำลังทำงานอยู่หรือไม่ก่อนที่จะเรียกใช้ session_start()
...
<div class="row">
    ...
    <div class="col-md-8" style="text-align:right; line-height: 30px; color:white;">
        <form method="post" action="logout.php">
            <span class="glyphicon glyphicon-user"></span> ยินดีต้อนรับคุณ : <b><?php echo $_SESSION['user']; ?></b>
            <input type="submit" value="ออกจากระบบ" onClick="return confirm('คุณต้องการออกจากระบบจริงหรือไม่')" class="btn btn-default btn-xs" />
